...
import HSWM.Layout.LayoutModifier (ModifiedLayout(..), LayoutModifier(handleMessOrMaybeModifyIt, redoLayout))
import HSWM
import HSWM.Util.Stack (reverseS)
import qualified Data.List.NonEmpty as NE
import qualified Data.Map as M
import qualified HSWM.StackSet as W
import Data.List (union, find, iterate, (\\))
...
data BoringMessage = FocusUp | FocusDown | FocusMaster | IsBoring RiverWindow | ClearBoring
