...
--
-- > import qualified HSWM.Actions.DynamicWorkspaceOrder as DO
--
-- Then add keybindings to swap the order of workspaces (these
-- examples use "HSWM.Util.EZConfig" emacs-style keybindings):
--
-- >        , ("M-C-<R>",   DO.swapWith Next NonEmptyWS)
-- >        , ("M-C-<L>",   DO.swapWith Prev NonEmptyWS)
--
-- See "HSWM.Actions.CycleWS" for information on the possible
...
-- "HSWM.Hooks.StatusBar.PP", use 'getSortByOrder' in your
-- 'HSWM.Hooks.StatusBar.PP.ppSort' field, for example:
--
-- >   myPP = ... byorgeyPP {
-- >     ...
...
-- "HSWM.Actions.CycleWS", use the versions of 'moveTo',
