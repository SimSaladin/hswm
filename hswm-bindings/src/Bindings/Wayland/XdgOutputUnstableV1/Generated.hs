  ...
  , logical_size :: RIP.FunPtr (RIP.Ptr RIP.Void -> RIP.Ptr Zxdg_output_v1 -> HsBindgen.Runtime.LibC.Int32 -> HsBindgen.Runtime.LibC.Int32 -> IO ())
    {- ^ size of the output in the global compositor space
         ...
         * A compositor scaling the monitor viewport using a fractional scale of 1.5 will advertise a logical size of 2560×1440.
         ...
         [__@width@__]: width in global compositor space

         [__@height@__]: height in global compositor space
...
foreign import ccall safe "wrapper" hs_bindgen_0977e9b6283582ce_base ::
...
hs_bindgen_0977e9b6283582ce ::
     (RIP.Ptr RIP.Void -> RIP.Ptr Zxdg_output_v1 -> IO ())
  -> IO (RIP.FunPtr (RIP.Ptr RIP.Void -> RIP.Ptr Zxdg_output_v1 -> IO ()))
hs_bindgen_0977e9b6283582ce =
  \fun0 ->
    fmap RIP.castFunPtrFromFFIType (hs_bindgen_0977e9b6283582ce_base (RIP.toFFIType fun0))

foreign import ccall safe "dynamic" hs_bindgen_10b728b3998c6073_base ::
...
hs_bindgen_10b728b3998c6073 ::
     RIP.FunPtr (RIP.Ptr RIP.Void -> RIP.Ptr Zxdg_output_v1 -> IO ())
  -> RIP.Ptr RIP.Void -> RIP.Ptr Zxdg_output_v1 -> IO ()
hs_bindgen_10b728b3998c6073 =
  \funPtr0 ->
    RIP.fromFFIType (hs_bindgen_10b728b3998c6073_base (RIP.castFunPtrToFFIType funPtr0))

instance RIP.ToFunPtr (RIP.Ptr RIP.Void -> RIP.Ptr Zxdg_output_v1 -> IO ()) where

  toFunPtr = hs_bindgen_0977e9b6283582ce

instance RIP.FromFunPtr (RIP.Ptr RIP.Void -> RIP.Ptr Zxdg_output_v1 -> IO ()) where

  fromFunPtr = hs_bindgen_10b728b3998c6073

foreign import ccall safe "wrapper" hs_bindgen_4538e1ddb392c8cb_base ::
...
hs_bindgen_4538e1ddb392c8cb =
  \fun0 ->
    fmap RIP.castFunPtrFromFFIType (hs_bindgen_4538e1ddb392c8cb_base (RIP.toFFIType fun0))

foreign import ccall safe "dynamic" hs_bindgen_ff11de08a94396d9_base ::
...
hs_bindgen_ff11de08a94396d9 ::
     RIP.FunPtr (RIP.Ptr RIP.Void -> RIP.Ptr Zxdg_output_v1 -> PtrConst.PtrConst RIP.CChar -> IO ())
  -> RIP.Ptr RIP.Void -> RIP.Ptr Zxdg_output_v1 -> PtrConst.PtrConst RIP.CChar -> IO ()
hs_bindgen_ff11de08a94396d9 =
  \funPtr0 ->
    RIP.fromFFIType (hs_bindgen_ff11de08a94396d9_base (RIP.castFunPtrToFFIType funPtr0))

instance RIP.ToFunPtr (RIP.Ptr RIP.Void -> RIP.Ptr Zxdg_output_v1 -> PtrConst.PtrConst RIP.CChar -> IO ()) where

  toFunPtr = hs_bindgen_4538e1ddb392c8cb

instance RIP.FromFunPtr (RIP.Ptr RIP.Void -> RIP.Ptr Zxdg_output_v1 -> PtrConst.PtrConst RIP.CChar -> IO ()) where

  fromFunPtr = hs_bindgen_ff11de08a94396d9

foreign import ccall safe "wrapper" hs_bindgen_c8aa4c4712471554_base ::
...
hs_bindgen_c8aa4c4712471554 =
  \fun0 ->
    fmap RIP.castFunPtrFromFFIType (hs_bindgen_c8aa4c4712471554_base (RIP.toFFIType fun0))

foreign import ccall safe "dynamic" hs_bindgen_865af6507a60f7e5_base ::
...
hs_bindgen_865af6507a60f7e5 ::
     RIP.FunPtr (RIP.Ptr RIP.Void -> RIP.Ptr Zxdg_output_v1 -> HsBindgen.Runtime.LibC.Int32 -> HsBindgen.Runtime.LibC.Int32 -> IO ())
  -> RIP.Ptr RIP.Void -> RIP.Ptr Zxdg_output_v1 -> HsBindgen.Runtime.LibC.Int32 -> HsBindgen.Runtime.LibC.Int32 -> IO ()
hs_bindgen_865af6507a60f7e5 =
  \funPtr0 ->
    RIP.fromFFIType (hs_bindgen_865af6507a60f7e5_base (RIP.castFunPtrToFFIType funPtr0))
...
instance RIP.ToFunPtr (RIP.Ptr RIP.Void -> RIP.Ptr Zxdg_output_v1 -> HsBindgen.Runtime.LibC.Int32 -> HsBindgen.Runtime.LibC.Int32 -> IO ()) where
  ...
  toFunPtr = hs_bindgen_c8aa4c4712471554
...
instance RIP.FromFunPtr (RIP.Ptr RIP.Void -> RIP.Ptr Zxdg_output_v1 -> HsBindgen.Runtime.LibC.Int32 -> HsBindgen.Runtime.LibC.Int32 -> IO ()) where
  ...
  fromFunPtr = hs_bindgen_865af6507a60f7e5
