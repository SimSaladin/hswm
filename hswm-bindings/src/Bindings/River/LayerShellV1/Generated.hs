...
module Bindings.River.LayerShellV1.Generated
    ( Bindings.River.LayerShellV1.Generated.River_layer_shell_output_v1
    , Bindings.River.LayerShellV1.Generated.River_layer_shell_seat_v1
    , Bindings.River.LayerShellV1.Generated.River_layer_shell_v1
    , Bindings.River.LayerShellV1.Generated.River_layer_shell_v1_error(..)
    , pattern Bindings.River.LayerShellV1.Generated.RIVER_LAYER_SHELL_V1_ERROR_OBJECT_ALREADY_CREATED
    , Bindings.River.LayerShellV1.Generated.rIVER_LAYER_SHELL_V1_DESTROY
    , Bindings.River.LayerShellV1.Generated.rIVER_LAYER_SHELL_V1_GET_OUTPUT
    , Bindings.River.LayerShellV1.Generated.rIVER_LAYER_SHELL_V1_GET_SEAT
    , Bindings.River.LayerShellV1.Generated.rIVER_LAYER_SHELL_V1_DESTROY_SINCE_VERSION
    , Bindings.River.LayerShellV1.Generated.rIVER_LAYER_SHELL_V1_GET_OUTPUT_SINCE_VERSION
    , Bindings.River.LayerShellV1.Generated.rIVER_LAYER_SHELL_V1_GET_SEAT_SINCE_VERSION
    , Bindings.River.LayerShellV1.Generated.River_layer_shell_output_v1_listener(..)
    , Bindings.River.LayerShellV1.Generated.rIVER_LAYER_SHELL_OUTPUT_V1_DESTROY
    , Bindings.River.LayerShellV1.Generated.rIVER_LAYER_SHELL_OUTPUT_V1_SET_DEFAULT
    , Bindings.River.LayerShellV1.Generated.rIVER_LAYER_SHELL_OUTPUT_V1_NON_EXCLUSIVE_AREA_SINCE_VERSION
    , Bindings.River.LayerShellV1.Generated.rIVER_LAYER_SHELL_OUTPUT_V1_DESTROY_SINCE_VERSION
    , Bindings.River.LayerShellV1.Generated.rIVER_LAYER_SHELL_OUTPUT_V1_SET_DEFAULT_SINCE_VERSION
    , Bindings.River.LayerShellV1.Generated.River_layer_shell_seat_v1_listener(..)
    , Bindings.River.LayerShellV1.Generated.rIVER_LAYER_SHELL_SEAT_V1_DESTROY
    , Bindings.River.LayerShellV1.Generated.rIVER_LAYER_SHELL_SEAT_V1_FOCUS_EXCLUSIVE_SINCE_VERSION
    , Bindings.River.LayerShellV1.Generated.rIVER_LAYER_SHELL_SEAT_V1_FOCUS_NON_EXCLUSIVE_SINCE_VERSION
    , Bindings.River.LayerShellV1.Generated.rIVER_LAYER_SHELL_SEAT_V1_FOCUS_NONE_SINCE_VERSION
    , Bindings.River.LayerShellV1.Generated.rIVER_LAYER_SHELL_SEAT_V1_DESTROY_SINCE_VERSION
    )
  where
...
data River_layer_shell_output_v1_listener = River_layer_shell_output_v1_listener
  { non_exclusive_area :: RIP.FunPtr (RIP.Ptr RIP.Void -> RIP.Ptr River_layer_shell_output_v1 -> HsBindgen.Runtime.LibC.Int32 -> HsBindgen.Runtime.LibC.Int32 -> HsBindgen.Runtime.LibC.Int32 -> HsBindgen.Runtime.LibC.Int32 -> IO ())
    {- ^ area left after subtracting exclusive zones
         ...
         [__@width@__]: area width

         [__@height@__]: area height
...
foreign import ccall safe "wrapper" hs_bindgen_f230e9a346846f9e_base ::
...
hs_bindgen_f230e9a346846f9e =
  \fun0 ->
    fmap RIP.castFunPtrFromFFIType (hs_bindgen_f230e9a346846f9e_base (RIP.toFFIType fun0))

foreign import ccall safe "dynamic" hs_bindgen_e991368c42dd068d_base ::
...
hs_bindgen_e991368c42dd068d ::
     RIP.FunPtr (RIP.Ptr RIP.Void -> RIP.Ptr River_layer_shell_output_v1 -> HsBindgen.Runtime.LibC.Int32 -> HsBindgen.Runtime.LibC.Int32 -> HsBindgen.Runtime.LibC.Int32 -> HsBindgen.Runtime.LibC.Int32 -> IO ())
  -> RIP.Ptr RIP.Void -> RIP.Ptr River_layer_shell_output_v1 -> HsBindgen.Runtime.LibC.Int32 -> HsBindgen.Runtime.LibC.Int32 -> HsBindgen.Runtime.LibC.Int32 -> HsBindgen.Runtime.LibC.Int32 -> IO ()
hs_bindgen_e991368c42dd068d =
  \funPtr0 ->
    RIP.fromFFIType (hs_bindgen_e991368c42dd068d_base (RIP.castFunPtrToFFIType funPtr0))
...
instance RIP.ToFunPtr (RIP.Ptr RIP.Void -> RIP.Ptr River_layer_shell_output_v1 -> HsBindgen.Runtime.LibC.Int32 -> HsBindgen.Runtime.LibC.Int32 -> HsBindgen.Runtime.LibC.Int32 -> HsBindgen.Runtime.LibC.Int32 -> IO ()) where
  ...
  toFunPtr = hs_bindgen_f230e9a346846f9e
...
instance RIP.FromFunPtr (RIP.Ptr RIP.Void -> RIP.Ptr River_layer_shell_output_v1 -> HsBindgen.Runtime.LibC.Int32 -> HsBindgen.Runtime.LibC.Int32 -> HsBindgen.Runtime.LibC.Int32 -> HsBindgen.Runtime.LibC.Int32 -> IO ()) where
  ...
  fromFunPtr = hs_bindgen_e991368c42dd068d

foreign import ccall safe "wrapper" hs_bindgen_2749b0a30daad4a6_base ::
...
hs_bindgen_2749b0a30daad4a6 ::
     (RIP.Ptr RIP.Void -> RIP.Ptr River_layer_shell_seat_v1 -> IO ())
  -> IO (RIP.FunPtr (RIP.Ptr RIP.Void -> RIP.Ptr River_layer_shell_seat_v1 -> IO ()))
hs_bindgen_2749b0a30daad4a6 =
  \fun0 ->
    fmap RIP.castFunPtrFromFFIType (hs_bindgen_2749b0a30daad4a6_base (RIP.toFFIType fun0))

foreign import ccall safe "dynamic" hs_bindgen_7d63a7d94292ef5d_base ::
...
hs_bindgen_7d63a7d94292ef5d ::
     RIP.FunPtr (RIP.Ptr RIP.Void -> RIP.Ptr River_layer_shell_seat_v1 -> IO ())
  -> RIP.Ptr RIP.Void -> RIP.Ptr River_layer_shell_seat_v1 -> IO ()
hs_bindgen_7d63a7d94292ef5d =
  \funPtr0 ->
    RIP.fromFFIType (hs_bindgen_7d63a7d94292ef5d_base (RIP.castFunPtrToFFIType funPtr0))

instance RIP.ToFunPtr (RIP.Ptr RIP.Void -> RIP.Ptr River_layer_shell_seat_v1 -> IO ()) where

  toFunPtr = hs_bindgen_2749b0a30daad4a6

instance RIP.FromFunPtr (RIP.Ptr RIP.Void -> RIP.Ptr River_layer_shell_seat_v1 -> IO ()) where

  fromFunPtr = hs_bindgen_7d63a7d94292ef5d
