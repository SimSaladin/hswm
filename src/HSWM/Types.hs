...
type WindowSet   = W.StackSet  WorkspaceId (Layout Window) Window WorkspaceDetail ScreenId ScreenDetail
type WindowSpace = W.Workspace WorkspaceId (Layout Window) Window WorkspaceDetail
...
data ScreenDetail = SD { width, length :: Int }
